...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT An error was thrown because `let` is defined in the first 'while' loop, but called by the cosole.log statement which is outside of the first 'while' loop. So, it was called outside of its block scope.
  console.log(viewed)
