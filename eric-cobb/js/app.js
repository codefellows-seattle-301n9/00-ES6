...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT// **Let limits the scope to the block it is used. The error is stating "rando" is not defined I believe is because "let" made it specifically stuck in the while loop.
  console.log(viewed)
