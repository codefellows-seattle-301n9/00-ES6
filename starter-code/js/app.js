...
function displayPics(){
  ...
  // line 37 throws an error because rando is undefined since let is used to define it in line 32.  let limits the scope of rando to the block that it is used in.
  console.log(viewed)
