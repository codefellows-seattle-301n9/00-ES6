...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: It seems that 'let' reduces teh scope of a declared variable. Previously var enabled rando to be seen and used outside of the while loop while let does not.
  console.log(viewed)
