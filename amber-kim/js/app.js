...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: It seems that 'const' reduces teh scope of a declared variable. Previously var enabled rando to be seen and used outside of the while loop while const does not.
  console.log(viewed)
