...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT The console.log is outside of the brackets of the function in which it was declaired locally by let.  const declares variables in a local scope only.
  console.log(viewed)
