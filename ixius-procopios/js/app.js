...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT - Let locks the variable inside the code block. It's no longer accessible after it's pushed out of the code block into view. Let is block scoped and var is function scoped.   
