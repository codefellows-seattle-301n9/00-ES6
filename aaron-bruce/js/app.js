...
const pics = [document.getElementById('left'),
                document.getElementById('center'), //esl
                // int-disable-line
...
function displayPics(){
  ...
  //console.log(rando) is not within the same block scope that const rando = makeRandom(); is in and therefore comes up as undefined. const variables must be defined and called within the same block, statement, and/or expression on which they are used.
  console.log(viewed)
