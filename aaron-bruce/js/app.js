...
function displayPics(){
  ...
  //console.log(rando) is not within the same block scope that let rando = makeRandom(); is in and therefore comes up as undefined. let variables must be defined and called within the same block, statement, and/or expression on which they are used.
  console.log(viewed)
